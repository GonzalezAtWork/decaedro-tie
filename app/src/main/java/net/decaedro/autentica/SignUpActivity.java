...
import static net.decaedro.autentica.AuthenticatorActivity.ARG_ACCOUNT_TYPE;
import static net.decaedro.autentica.AuthenticatorActivity.KEY_ERROR_MESSAGE;
import static net.decaedro.autentica.AuthenticatorActivity.PARAM_USER_PASS;
